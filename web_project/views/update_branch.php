...
<div style="width:1200px;"  id="update_r" class="container">
    <div>
        <form method="POST" action="/SE/update_branch">
    ...
    <div > 
       ...
       $query2= 'UPDATE branch set  code="'.$codeEdit.'", name="'.$nameEdit.'" where branch_id like "'.$edit.'"'  ;
       
        
        $result2 = mysql_db_query($db, $query2);
        $query='SELECT branch_id,code as "รหัสที่สาขา",name as "ชื่อสาขา" FROM branch where '.$tb.' like "'.$kw.'%" ';       
